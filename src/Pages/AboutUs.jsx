    ...
    <section className="px-4 container mx-auto py-14 md:py-20">
      <div className="text-center max-w-3xl mx-auto mb-20">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          GreenNest is an elegant indoor plant store and care platform built for
          plant lovers. Discover, nurture, and decorate your home with healthy
          indoor plants while getting expert guidance for a greener, healthier
          living space.
        </p>
      </div>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-600 text-lg leading-relaxed text-center md:text-left">
              ...
              deeply rewarding. At GreenNest, we believe that plants do far more
              than simply decorate a room—they breathe life into spaces, uplift
              moods, improve air quality, and create a sense of harmony that
              modern living often lacks. We are committed to helping people
              reconnect with nature, even within the busiest urban environments.
              Through our carefully curated selection of premium indoor plants,
              we ensure that every customer receives healthy, vibrant greenery
              that can truly thrive. But we don't stop there. To make plant care
              easier and more fulfilling, we offer in-depth care guides,
              seasonal tips, and expert recommendations designed to support
              plant lovers of all skill levels—from complete beginners to
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
          Our dedicated team of plant enthusiasts and developers work tirelessly
          to bring GreenNest to life, helping you nurture your indoor garden
          with care and style.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        {[
          ...
          <div
            key={index}
            className="bg-white rounded-xl shadow-md p-6 text-center hover:shadow-xl transition-transform duration-300 hover:scale-105"
          >
            <img
              src={member.img}
              alt={member.name}
