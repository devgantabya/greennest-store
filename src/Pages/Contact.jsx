    ...
    <section className="px-4 container mx-auto py-12 md:py-20">
      <div className="text-center max-w-2xl mx-auto mb-16">
        ...
        <p className="text-lg text-gray-600">
          We're here to help! Whether you have questions about plants, need care
          advice, or want to get in touch with our support team — feel free to
          reach out anytime.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-green-50 p-8 rounded-xl shadow hover:shadow-xl transition text-center">
        ...
        <div className="bg-green-50 p-8 rounded-xl shadow hover:shadow-xl transition text-center">
          ...
          <p className="text-gray-600">GreenNest HQ, California, USA</p>
        </div>
      </div>
        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#209d50]"
            />
          </div>
